...
@section('content')
    <div class="mb-12 mt-4">
        ...
        <div class="ml-0 md:ml-10">
            <p class="text-lg text-slate-600 leading-relaxed border-l-4 border-indigo-500 ps-6">
                <strong>Queue</strong> (Antrean) adalah struktur data linear yang mengikuti prinsip <strong class="text-indigo-600 italic">FIFO (First In First Out)</strong>. Artinya, elemen yang pertama kali masuk adalah yang pertama kali akan keluar atau diproses.
            </p>
            ...
            <div class="bg-indigo-50 p-6 rounded-2xl mt-8 border border-indigo-100 flex gap-4 items-start">
                ...
                <p class="text-sm text-indigo-900 leading-relaxed">
                    <strong>Analogi:</strong> Bayangkan antrean murid di layanan TU. Murid yang datang paling awal akan dilayani terlebih dahulu, sementara murid yang baru datang harus menunggu di belakang.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="mb-16">
        ...
        <div class="ml-0 md:ml-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="group p-6 bg-white border border-slate-100 rounded-[2rem] hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">Menambahkan data atau elemen baru ke posisi paling belakang (<span class="italic">rear</span>) dari antrean.</p>
            </div>
            ...
            <div class="group p-6 bg-white border border-slate-100 rounded-[2rem] hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">Menghapus atau mengambil data dari posisi paling depan (<span class="italic">front</span>) antrean.</p>
            </div>
    ...
    <div class="mb-16 bg-slate-900 rounded-[3rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-indigo-200">
        ...
        <div class="relative z-10">
            ...
            <p class="text-slate-300 text-lg leading-relaxed mb-0">
                Queue menjamin <span class="text-indigo-400 font-bold italic">keadilan</span> dalam pemrosesan data. Dalam dunia pemrograman, Queue digunakan mulai dari sistem manajemen printer, pengaturan lalu lintas data jaringan, hingga penjadwalan tugas (scheduling) pada sistem operasi.
            </p>
        </div>
    </div>
