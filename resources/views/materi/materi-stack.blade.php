        ...
        <div class="ml-0 md:ml-10">
            ...
            <div class="bg-indigo-50 p-6 rounded-2xl mt-8 border border-indigo-100 flex gap-4 items-start">
                <div class="bg-indigo-600 p-2 rounded-lg shrink-0 mt-1">
                    <i data-lucide="book-open" class="text-white w-4 h-4"></i>
                </div>
                <div class="space-y-1">
    ...
    <div class="mb-16">
        ...
        <div class="ml-0 md:ml-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="group p-6 bg-white border border-slate-100 rounded-[2rem] hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">Menambahkan atau menumpuk data baru ke posisi paling atas (<span class="italic">Top</span>) dari tumpukan.</p>
            </div>
            ...
            <div class="group p-6 bg-white border border-slate-100 rounded-[2rem] hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                <div class="w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <i data-lucide="arrow-up-from-dot"></i>
                </div>
                <h6 class="font-bold text-slate-800 mb-2">2. Pop</h6>
                <p class="text-slate-500 text-sm leading-relaxed">Menghapus atau mengambil elemen yang berada di posisi paling atas (<span class="italic">Top</span>) tumpukan.</p>
            </div>
            ...
            <div class="group p-6 bg-white border border-slate-100 rounded-[2rem] hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                ...
                <h6 class="font-bold text-slate-800 mb-2">3. Top (Peek)</h6>
    ...
    <div class="mb-16 bg-slate-900 rounded-[3rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-indigo-200">
        ...
        <div class="relative z-10">
            ...
            <p class="text-slate-300 text-lg leading-relaxed mb-0">
                Stack sangat penting untuk menyimpan <strong>riwayat aktivitas</strong>. Contoh nyatanya adalah fitur <span class="text-indigo-400 italic">Undo/Redo</span> pada teks editor, tombol <span class="text-indigo-400 italic">Back</span> pada browser, hingga proses pemanggilan fungsi dalam pemrograman.
            </p>
        </div>
    </div>
